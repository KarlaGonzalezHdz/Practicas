...
$consulta = "insert into empleados (nombre, apellidop, apellidom, fechaNac, correo , Telefono) values ('".$_POST['nombre']."','".$_POST['apellidop']."','".$_POST['apellidom']."',
'".$_POST['fechaNac']."','".$_POST['correo']."','".$_POST['Telefono']."')";
